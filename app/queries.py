...
def save_canarydrop(canarydrop=None):
    ...
    db.hmset(KEY_CANARYDROP + canarytoken.value(), canarydrop.serialize(bool_as_int=True))
    ...
    if db.zscore(KEY_CANARYDROPS_TIMELINE, canarytoken.value()) == None:
        ...
        db.zadd(KEY_CANARYDROPS_TIMELINE, {canarytoken.value(): current_time})
